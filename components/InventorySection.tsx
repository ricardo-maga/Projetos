    ...
    <div className="space-y-6">
      ...
      {subTab === 'materials' ? (
        ...
        isEditingMaterial ? (
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-2xs overflow-hidden animate-fade-in text-xs font-bold text-slate-700">
            ...
            <div className="p-4 sm:p-5 border-b border-slate-200/80 bg-slate-50/60 space-y-3.5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">Referências registadas para incorporação em propostas comerciais (BOM).</p>
                </div>
                <button 
                  type="button"
            ...
            <div className="overflow-x-auto w-full">
              {filteredMaterials.length === 0 ? (
                <div className="p-10 text-center text-slate-400 font-medium text-xs">Nenhum material registado.</div>
              ) : (
                <table className="w-full min-w-[700px] text-left border-collapse">
                  <thead className="bg-slate-50/90 text-[11px] uppercase tracking-wider text-slate-500 font-bold border-b border-slate-200/80 whitespace-nowrap select-none">
                    <tr>
                      <th className="px-5 py-3.5 text-left">Artigo / Nome</th>
                      <th className="px-5 py-3.5 text-left">Código Interno</th>
                      <th className="px-5 py-3.5 text-left">Ref. Fabricante</th>
                      <th className="px-5 py-3.5 text-left">Fornecedor</th>
                      <th className="px-5 py-3.5 text-right">Custo Unitário</th>
        ...
        isEditingEq ? (
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-2xs overflow-hidden animate-fade-in text-xs font-bold text-slate-700">
            ...
            <div className="p-4 sm:p-5 border-b border-slate-200/80 bg-slate-50/60 space-y-3.5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">Gestão e rastreabilidade de máquinas, números de série e marca nos clientes.</p>
                </div>
                <button 
                  type="button"
            ...
            <div className="overflow-x-auto w-full">
              {filteredEq.length === 0 ? (
                <div className="p-10 text-center text-slate-400 font-medium text-xs">Nenhum equipamento industrial registado.</div>
              ) : (
                <table className="w-full min-w-[700px] text-left border-collapse">
                  <thead className="bg-slate-50/90 text-[11px] uppercase tracking-wider text-slate-500 font-bold border-b border-slate-200/80 whitespace-nowrap select-none">
                    <tr>
                      <th className="px-5 py-3.5 text-left">Número de Série (S/N)</th>
                      <th className="px-5 py-3.5 text-left">Marca / Modelo</th>
                      <th className="px-5 py-3.5 text-left">Instalado no Cliente</th>
                      <th className="px-5 py-3.5 text-left">Data de Instalação</th>
